...
public class game_five_result extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_five_result);
        ...
        int second = getIntent().getIntExtra("time", 0);
        Log.d("game_five", "Second Value: " + second);
